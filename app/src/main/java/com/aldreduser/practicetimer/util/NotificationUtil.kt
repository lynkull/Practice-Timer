...
import com.aldreduser.practicetimer.AppConstants
import com.aldreduser.practicetimer.MainActivity
import com.aldreduser.practicetimer.R
import com.aldreduser.practicetimer.TimerNotificationActionReceiver
import java.text.SimpleDateFormat
import java.util.*

class NotificationUtil {
    companion object{
        //can call these methods from anywhere whithout needing and instance from notification util
        ...
        fun showTimerExpired(context: Context){
            ...
            nManager.createNotificationChannel(CHANNEL_ID_TIMER, true, CHANNEL_NAME_TIMER)
        ...
        @TargetApi(26)
        private fun NotificationManager.createNotificationChannel(channelName: String,
                                                                  playSound: Boolean,
                                                                  channelId: String){
